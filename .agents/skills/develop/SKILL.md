...
4. Run `python3 .agents/skills/validate/scripts/validate_work_item.py <work_item_dir> --check all` before coding.
...
9. Run `python3 .agents/skills/validate/scripts/validate_work_item.py <work_item_dir> --check all` after implementation.
