...
9. Run:
   - `python3 .agents/skills/requirements/scripts/requirements_trace.py <work_item_dir> --action capture --bulk-file <bulk_payload_path>`
   - `python3 .agents/skills/requirements/scripts/requirements_trace.py <work_item_dir> --action validate_structure`
   - `python3 .agents/skills/validate/scripts/validate_work_item.py <work_item_dir> --check prd`
