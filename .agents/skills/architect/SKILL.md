...
7. Run:
   - `python3 .agents/skills/requirements/scripts/requirements_trace.py <work_item_dir> --action verify_fdd`
   - `python3 .agents/skills/requirements/scripts/requirements_trace.py <work_item_dir> --action master_validate --stage fdd_only`
   - `python3 .agents/skills/validate/scripts/validate_work_item.py <work_item_dir> --check fdd`
