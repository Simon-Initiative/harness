...
9. Run:
   - `python3 ../requirements/scripts/requirements_trace.py <work_item_dir> --action capture --bulk-file <bulk_payload_path>`
   - `python3 ../requirements/scripts/requirements_trace.py <work_item_dir> --action validate_structure`
   - `python3 ../validate/scripts/validate_work_item.py <work_item_dir> --check prd`
